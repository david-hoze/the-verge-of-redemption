...
- `friends/` - Profiles and correspondence with friends/collaborators
...
- `torah-writing/` - Submodule: Hebrew source texts and Torah writing
...
- `marriage-counseling/` - Marriage counseling session transcripts (4 sessions)
...
- `data/` - Data files
- `download.idr` - Article downloader from Substack API
